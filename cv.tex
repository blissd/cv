...
High calibre SENIOR JAVA DEVELOPER with 13 years experience in software design and development in \textbf{financial}, commercial insurance, loyalty, and law enforcement industries.

\head{Expertise (non-exhaustive)}

\begin{tabular}{| r | p{14cm} | }
\hline
Languages and APIs & Java, Guava, SQL, EJB, Spring, Hibernate, JPA, JMS, JAXB, JSP, Jackson, Swing, Mockito, JUnit, TestNG, JBehave, Cucumber, Wicket, XML, XSD, XSLT, C, Bourne Shell, Sed, Awk \\
\hline
Methodologies & Agile, XP, TDD, BDD \\
\hline
Databases & Oracle 10g, MySQL, Mongo, SQL Server, HSQL, SQLite, PL/SQL \\
\hline
Application Servers & JBoss, Tomcat, Jetty, WebLogic, WebSphere, OC4J \\
\hline
