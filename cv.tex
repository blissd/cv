...
\expertise{Core Experience}{Scala, Kafka, Kafka Streams, Apache Spark, Kubernetes, Helm, Cassandra, big data, batch and stream processing.}

\expertise{AWS}{EMR, S3, ECR, Kinesis, Data Pipelines.}

\expertise{Languages and APIs}{Scala, Java, Python, SQL, Spring, Hibernate, JUnit, Linux.}
