...
\begin{center}
\href{mailto:cv@davidbliss.me}{cv@davidbliss.me}
...
\item Engineered a streaming data platform processing \textbf{40,000} messages per second.
...
Developed the credit card payment user interface and backend for Yaap Shopping, a \textbf{first of its kind} venture between a telecoms company (Telef\'onica) and a bank (Santander and Caixa)\\
...
\techstack{AWS, REST, apache Camel, Mongo DB, Rabbit MQ, Java, Spring, MySQL, asynchronous events, pair programming.}\\
