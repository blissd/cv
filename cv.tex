...
\techstack{Scala, Spark, Kafka, Cassandra, Python, Java, Spring, and REST.}\\
...
\techstack{Java, Spring Batch, Spring Integration, Spring MVC, RabbitMQ, REST, Google Guava, MySQL, and Tomcat.}\\
...
\techstack{AWS, REST, Camel, Mongo DB, Rabbit MQ, Java, Spring, MySQL, asynchronous events, pair programming.}\\
...
\techstack{Java, Spring, Hibernate, idempotency, compensating transactions, parallelism.}\\
